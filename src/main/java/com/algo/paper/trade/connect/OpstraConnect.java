...
//	private String cookieVal;
	...
	public AlgoOptionChainList getOptionChainData(String symbol, String expiry) {
		...
		String url = OPSTR_OC_URL+symbol+"&"+expiry;
	...
	public Map<String, AlogLtpData> getSpotLtpData(List<String> symbols, String expiry) {
		HttpHeaders headers = new HttpHeaders();
		headers.set("user-agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/95.0.4638.54 Safari/537.36");
...
//		headers.set("cookie", cookieVal);
		...
		for(String symbol: symbols) {
			String url = OPSTR_SPOT_LTP_URL+symbol+"&"+expiry;
			log.info("URL: "+url);
...
//		headers.set("cookie", cookieVal);
	...
	public Map<String, AlgoOptionChain> getOpstStrangleStrikes(String symbol, String expiry, Double deltaVal, Double deltaMaxDiff) {
